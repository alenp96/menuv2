...
import { MenuSection as MenuSectionType, MenuItem, Menu, assertMenuSection, assertMenuItem } from '../types';
...
const MenuSection: React.FC<MenuSectionProps> = ({ section, menu, onSectionUpdated }) => {
